...
# Step 4 - The workflow script with file info separated into 
#     variables.
#=================================================================
# Script: step4-script_with_variables.sh
# Author: Sarah Keefe
# Last Updated: 2023-06-10
# 
# Purpose: This is the script from step 3 with any information
# that you might want to change separated into variables that get
...
# In the tutorial example, the data is organized into sub-folders for each scan 
# session, with a second level of sub-folders for each scan in the session.
...
# freesurfers_dir
# This is the full path to the directory where your FreeSurfer output (subject 
# folders) is located.
...
# dti_scan_filename
# The filename of the NIFTI file for your DTI scan for the scan session you are 
# working with.
