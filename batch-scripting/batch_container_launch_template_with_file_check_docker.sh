...
#=================================================================
# Script: batch_container_launch_template_with_file_check_docker.sh
# Author: Sarah Keefe
...
#      Docker container launch command into this script.
#
# Usage: ./batch_container_launch_template_with_file_check_docker.sh 
...
cat ${input_file} | while IFS=, read -r session_label dti_scan_id fi_threshold_value gradient_value; do
	...
	# based on scan ID
	#-----------------
	# Make sure we have the correct files for our DTI scan ID
